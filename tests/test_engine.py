...
class TestFiltering:
    ...
    def test_filter_dice(self):
        ...
        config = {
            "content": {"include_dice": False, "include_system": True, "include_effects": True}
        }
...
class TestMerge:
    ...
    def test_merge_consecutive(self):
        ...
        config = {"dialogue": {"merge_consecutive": True, "merge_separator": "\n", "merge_max": 5}}
...
class TestSceneSplit:
    ...
    def test_split_by_count(self):
        ...
        config = {
            "chapter": {"split_mode": "count", "entries_per_chapter": 3, "title_format": "장면 {n}"}
        }
        scenes = split_into_scenes(entries, config)
